...
/**
 * This is a template for creating JUnit tests for Habitat4J.
 * 
 ...
 * @version $Id: ApplicationXTestCaseTemplate.java,v 1.3 2004/08/20 11:00:03 cvs Exp $
 */
public class ApplicationXTestCaseTemplate extends Habitat4JBaseTestCase implements Habitat4JConstants {
	private static final String APPLICATION_NAME			= "apps/ApplicationXXX";
	private static final String SERVER_NAME					= "servers/YYY/ZZZ/";
	...
	protected void doLoadFromResource() throws PropertyListHandlerException {
		String applicationPropertyPackage = DATA_EXAMPLES_RESOURCE_PATH + APPLICATION_NAME;
	...
	public ApplicationXTestCaseTemplate(String arg0) {
		super(arg0);
	}
}
