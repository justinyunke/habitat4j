...
/**
 * This class consists of JUnit tests for deploying Application D on Unit Testing Server #1
 * with Habitat4J.
 * 
 ...
 * @version $Id: ApplicationDonUnitTesting1TestCase.java,v 1.8 2004/08/20 11:00:03 cvs Exp $
 */
public class ApplicationDonUnitTesting1TestCase extends Habitat4JBaseTestCase implements Habitat4JConstants {
	...
	public void testLDAPonUnitServer1() {
		try {
			doLoadFromResource();
	...
	public ApplicationDonUnitTesting1TestCase(String arg0) {
		super(arg0);
	}
}
