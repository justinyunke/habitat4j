...
/**
 * Exception used for DecoderIF implementation runtime problems.
 * 
 ...
 * @version $Id: DecoderException.java,v 1.2 2005/03/23 07:55:45 cvs Exp $
 */
public class DecoderException extends Exception implements Habitat4JConstants {
	private static final long serialVersionUID = 3256725074055541040L;
	 ...
	 */
	public DecoderException(String message,byte level) {
		super(message);
		logger = Habitat4JLogger.getInstance();
