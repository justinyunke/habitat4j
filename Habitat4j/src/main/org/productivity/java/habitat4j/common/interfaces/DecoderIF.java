...
/**
 * Interface used to implement a property value decoder.
 * 
 ...
 * @version $Id: DecoderIF.java,v 1.4 2005/03/30 04:04:34 cvs Exp $
 */
public interface DecoderIF {
	 ...
	 */
	public void initialize(String appName, String propertyListName) throws DecoderException;
	
	/**
	 * @param propertyListName - the name of the PropertyList that's calling this method (use is optional)
	 * @param name - the Property name (use is optional)
	 * @param value - the String value to decode
	 * @return Returns a decoded String from parameter "value"
	 * @throws DecoderException
	 */
	public String decode(String propertyListName, String name, String value) throws DecoderException;
}
